const Input = ({
  ...
  let inputClasses = `form-input peer w-full border rounded-md shadow-sm border-gray-300 placeholder:text-white text-sm placeholder-opacity-0 focus:ring-0 focus:border-primary text-dark py-3 px-2.5 outline-none transition-all ${className} `;
