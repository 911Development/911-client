const Input = ({
  ...
  let labelClasses =
    "peer absolute text-muted dark:text-muted-dark left-2 top-0 peer-focus:text-primary peer-placeholder-shown:text-dark peer-placeholder-shown:!top-1/2 -translate-y-1/2 peer-placeholder-shown:text-gray-500 text-sm bg-white dark:bg-black peer-focus:!top-0 transition-all cursor-text px-1 ";
